...
import eu.smesec.library.user_training.UtrainingLib;
...
public class TestUtrainingLib {
    private UtrainingLib library;
    private Questionnaire coach;
    private ILibCal libcal;
    private String libId = "eu.smesec.library.TestUtrainingLib";
    private String xmlFile = "/lib-user-training.xml";
    ...
    public void setup() {
        ...
        when(coach.getId()).thenReturn("User training");
